...
extern void print_six(Seq_T instructions);
extern void conditional_move_test(Seq_T stream);
...
extern void build_segmented_load_store_test(Seq_T stream);
extern void build_segmented_load_store_test2(Seq_T stream); 
...
static struct test_info {
        ...
        { "print-six",         NULL, "", print_six },
        { "conditional-move",         NULL, "",  conditional_move_test },
        { "output",         NULL, "",  build_output_test },
        { "loadval",         NULL, "",  build_loadval_test },
        { "input",         NULL, "",  build_input_test },
        { "segmented-loadstore",  NULL, "",  build_segmented_load_store_test },
        { "segmented-loadstore2", NULL, "",  build_segmented_load_store_test2 },
